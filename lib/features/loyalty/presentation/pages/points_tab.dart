...
class PointsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SDKUserBalanceHistoryController>(
      init: SDKUserBalanceHistoryController(context: context),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(title: Text("myPoints".sdkTr.toUpperCase())),
