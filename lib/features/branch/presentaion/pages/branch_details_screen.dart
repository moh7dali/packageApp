          ...
          child: controller.isLoading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [Text(controller.branchDetails?.name ?? "", style: AppTheme.textStyle(color: AppTheme.textColor, size: 18))],
                    ),
                    SizedBox(height: Get.height * .02),
                    Row(
                      children: [
                        Expanded(
                          child: Text(controller.branchDetails?.description ?? "", style: AppTheme.textStyle(color: AppTheme.textColor, size: 14)),
                        ),
                      ],
                    ),
                    SizedBox(height: Get.height * .02),
