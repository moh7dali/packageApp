...
abstract class BranchRepository {
  Future<Either<AppFailure, BranchDetailsList>> getAllBranches({Map<String, dynamic>? body});
  ...
  Future<Either<AppFailure, BranchDetails?>> getClosestBranch({required Map<String, dynamic> body});
}
