...
//     Color textColor = isHome ? AppTheme.textColor : AppTheme.textColor;
...
//                 style: AppTheme.textStyle(color: textColor, size: isHome ? AppTheme.size14 : AppTheme.size20, isBold: true),
//                 textAlign: TextAlign.start,
//               ),
//               SizedBox(height: isHome ? 10 : 20),
//               Row(
//                 children: [
//                   Expanded(
//                       child: Text(
//                         campaignDetails.description ?? "",
//                         style: AppTheme.textStyle(color: textColor, size: isHome ? AppTheme.size12 : AppTheme.size14),
//                         maxLines: isHome ? 3 : 5,
//                       )),
//                 ],
//               ),
//               if (!isHome) SizedBox(height: isHome ? 5 : 20),
//               if (!isHome)
//                 Row(
...
//                     Text(
//                       "discoverNow".tr,
//                       style: AppTheme.textStyle(color: isPrimary ? AppTheme.whiteColor : AppTheme.primaryColor, size: AppTheme.size16)
